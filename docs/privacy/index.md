...
- Reminder times
- Notes or instructions related to medication intake
- Medication status, such as taken or pending

This information is stored locally on the user's device unless future versions of the app introduce optional cloud sync or backup features.
...
Medication information remains stored locally on the user's device while the app is installed and the data is not manually deleted.

Users may delete medication entries inside the app, when available, or delete the app from the device to remove locally stored app data, subject to iOS backup and restore behavior.
...
- Confirming dosage and schedule instructions with a healthcare professional
- Keeping their medication information updated
...
This Privacy Policy may be updated from time to time to reflect changes in the app, legal requirements, or privacy practices.

When updates are made, the effective date at the top of this document will be revised.
